...
class HomeViewModel extends ChangeNotifier {
  ...
  HomeViewModel(this._ref) {
    clusterManager = cluster.ClusterManager<ParcoursClusterItem>([], _updateMarkers,
  ...
  IconData _filterParcourIcon = unicons.UniconsLine.globe;
  ...
  late cluster.ClusterManager<ParcoursClusterItem> clusterManager;
  ...
  Future<void> changeFilterParcour() async {
    ...
    if (_typeFilter == "public") {
      ...
      _filterParcourIcon = unicons.UniconsLine.lock;
      _typeFilter = "private";
    } else {
      _filterParcourIcon = unicons.UniconsLine.globe;
      _typeFilter = "public";
    }
    try {
      getParcour();
