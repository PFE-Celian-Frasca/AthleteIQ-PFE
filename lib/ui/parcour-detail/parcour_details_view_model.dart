...
class ParcourDetailsViewModel extends ChangeNotifier {
  final Ref _ref;
  ParcourDetailsViewModel(this._ref);

  UserRepository get _repository => _ref.read(userRepositoryProvider);
  ParcourRepository get parcourRepo => _ref.read(parcourRepositoryProvider);
  FirebaseAuth get auth => _ref.read(firebaseAuthProvider);
